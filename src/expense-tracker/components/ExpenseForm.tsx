...
const ExpenseForm = ({onSubmit}:Props) => {
  ...
  return (
    <form onSubmit={handleSubmit(data => {
        ...
        <h3 className="shadow-sm p-3 mb-5 bg-white rounded text-center">Expense Tracker</h3>
        ...
        <button className="btn" style={{backgroundColor:'purple', color:'white'}}>Submit</button>
        </div>
